...
output_file = 'ires/IRES_mb_docking.txt'
...
for fi, f in list(enumerate(docked_model_files)):
	...
	# column, and zip together their positions
	else:
		A_ires = zip_res_range([q[1] for q in out if q[0]=='A'])
		B_ires = zip_res_range([q[1] for q in out if q[0]=='B'])
